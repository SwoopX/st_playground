...
const char *RStateEco2 = "state/eco2";
...
const char *RStateVoc = "state/voc";
...
void initResourceDescriptors()
{
    ...
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeInt16, RStateEco2));
    ...
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt16, RStateVoc));
